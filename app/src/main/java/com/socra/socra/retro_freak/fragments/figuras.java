 ...
 * {@link figuras.OnFragmentInteractionListener} interface
...
public class figuras extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_figuras, container, false);

        layout= new LinearLayoutManager(getContext());

        productos = new ArrayList<>();
        recyclerView = view.findViewById(R.id.reciclerfig);
        getallfiguras();
