...
public class juego_de_tronos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juego_de_tronos);
        ...
        recyclerView = findViewById(R.id.Reciclerjdt);
        getallgot();
    ...
    private void getallgot(){
        productos.add(new productos(R.drawable.camijdt,"Camiseta Game Of Trones","40euros"));
